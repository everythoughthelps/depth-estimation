...
parser.add_argument('--data', default='F:/Resource/data/nyuv2', type=str, help='path of dataset')
...
def main():
    ...
    test_loader = loaddata.getTestingData(args.data, batch_size=1, num_classes=150)
